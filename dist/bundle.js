...
var AddressBook = /** @class */ (function () {
    ...
    AddressBook.prototype.addGroups = function (groupContact) {
        var doesNotExistInGroupContact = !this.listOfGroups.find(function (group) { return group.uuid === groupContact.uuid; });
...
var Contact = /** @class */ (function () {
    function Contact(name, surname, email) {
        _Validator__WEBPACK_IMPORTED_MODULE_1__["Validator"].isEmptyString(name);
        _Validator__WEBPACK_IMPORTED_MODULE_1__["Validator"].isEmptyString(surname);
        _Validator__WEBPACK_IMPORTED_MODULE_1__["Validator"].isWrongEmail(email);
    ...
    Contact.prototype.update = function (key, value) {
        ...
        if (key === 'email') {
            _Validator__WEBPACK_IMPORTED_MODULE_1__["Validator"].isWrongEmail(value);
        }
        this[key] = value;
    };
    return Contact;
...
/***/ "./src/components/GroupContact.ts":
/*!****************************************!*\
  !*** ./src/components/GroupContact.ts ***!
  \****************************************/
/*! exports provided: GroupContact */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GroupContact", function() { return GroupContact; });
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! uuid */ "./node_modules/uuid/dist/esm-browser/index.js");
/* harmony import */ var _Validator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Validator */ "./src/components/Validator.ts");
...
var Validator = /** @class */ (function () {
    ...
    Validator.isEmptyString = function (stringLikeValue) {
        if (stringLikeValue.length === 0)
